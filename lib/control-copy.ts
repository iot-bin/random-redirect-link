...
const en = {
  selectApi:'Select a management API',noApis:'Connect and authorize a management API in the management stack first.',selectDefault:'Select a default environment',
