...
const styles: Record<string, React.CSSProperties> = {
  ...
  h1: { margin: 0, fontSize: 15, fontWeight: 600, letterSpacing: '-0.01em', color: '#ffffff' },
  sub: { margin: '2px 0 0', color: '#666666', fontSize: 12 },
  card: {
    background: '#0a0a0a',
  ...
  hint: { color: '#666666', fontSize: 12, lineHeight: 1.5, marginTop: 4 },
  code: {
  ...
  checkboxLabel: { fontSize: 13, color: '#cccccc', lineHeight: 1.4 },
  numberInputRow: {
    display: 'flex',
    alignItems: 'center',
    gap: 10,
  ...
  numberLabel: { color: '#666666', fontSize: 12, whiteSpace: 'nowrap' as const },
  ...
  resultTitle: { fontSize: 16, fontWeight: 600, marginBottom: 16, color: '#ffffff', letterSpacing: '-0.01em' },
  kv: {
    display: 'grid',
  ...
  k: { color: '#666666', fontSize: 12, paddingTop: 1, fontWeight: 500 },
  v: {
    fontSize: 13,
    minWidth: 0,
    overflowWrap: 'anywhere',
